...
contract MyToken is ERC20Interface {
    ...
    string constant public name = "dz336"; // TODO CHANGE THIS!
    ...
    function withdraw(uint256 _num_tokens) returns (bool success) {
        ...
        // (otherwise throw)
        if (_num_tokens <= _accountBalances[msg.sender]){

            // Adjust data structures appropriately
            uint wei_withdrawn = _num_tokens*1000;
            ...
            // (throw if send fails)
             ...
             msg.sender.transfer(wei_withdrawn);
